...
def test_get_public_holidays():
    ...
    """ 
        TODO: Change this to a more recent year if the API stops returning. Initial data was for 2017 
        but the API may have updated data for more recent years or may not accept requests for 2017 anymore.
    """
    year = "2025" 
